            ...
            {sFood.id ?
                <div className='my-3'>
                    ...
                    <Container>
                        <Row>
                            <Col lg={6} >
                                <img src={sFood?.image} style={{ width: "100%", }} alt="" className='rounded-4 mb-4' />
                            </Col>
                            <Col lg={6}>
                                ...
                                <div className=' text-black p-4 shadow-lg rounded-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text'>Rating : <span className={sFood?.rating > 4.5 ? "text-success" : "text-warning"} style={{ fontWeight: '700' }}>{sFood?.rating}</span><i className="fa-solid fa-star" style={{ color: "#FFD43B" }}></i></p>
                                        <p className='text1'>ReviewCount : (<b>{sFood?.reviewCount}</b>)</p>
                                    ...
                                    <div className='mt-3'>
                                        <Accordion defaultActiveKey="0">
                                            <Accordion.Item eventKey="0">
                                                <Accordion.Header><b>Ingredients</b></Accordion.Header>
                                                <Accordion.Body>
